...
import {get as getSavedPagesFromDB} from './db/history'
...
export function toggleSection (title, index) {
  return { type: TOGGLE_SECTION, title, index }
}
...
export function loadHistory () {
  return (dispatch, getState) =>
    getSavedPagesFromDB().then((titles) =>
      dispatch({ type: CACHED_PAGES, titles }))
}
